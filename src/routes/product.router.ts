...
productRouter.put('/products/:id', authMiddleware, requireActiveSeller(), uploadImages, validateBody(UpdateProductSchema), updateProduct);
productRouter.put('/products/:productId/active-status', authMiddleware, requireActiveSeller(), validateProduct(), updateProductActiveStatus);