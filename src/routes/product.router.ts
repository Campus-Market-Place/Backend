...
import { createProduct, deleteProduct, getProductDetails, getProductsByCategory, getProductsByShop, updateProductActiveStatus } from '../controllers/product.controller.js';
